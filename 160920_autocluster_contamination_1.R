...
# criteria in line 58-66 need to be adjusted for other data sets
...
contigCoord <- read.delim(paste0(LIB,"_concat.contigs.1.rRNAcut.fa_5mer_clr.coords"),header=F,stringsAsFactors=F,sep=",") #change this!
contigNames <- read.delim(paste0(LIB,"_concat.contigs.1.rRNAcut.names.txt"),header=F,stringsAsFactors=F) #change this! 
