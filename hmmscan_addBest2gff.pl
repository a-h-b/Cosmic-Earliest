...
#script to add results from hmm scan to .gff file.
#written by Anna Heintz-Buschart, December 2016, based on code by Venkata Satagopam

use strict;
use Getopt::Long;

my ($hmmscan_result_file,$gf_file,$namearg,$out_file,$cutoff,$geneno,$keepAll,$trim);
GetOptions('h|hmm=s' => \$hmmscan_result_file,
