...
#coordinates
cutrRNA_coords <- read.delim(paste0(cutdir,LIB,"/",LIB,"_concat.contigs.1.rRNAcut.fa_5mer_clr.coords"),header=F,sep=',')
colnames(cutrRNA_coords) <- c("x","y")
Names <- read.delim(paste0(cutdir,LIB,"/",LIB,"_concat.contigs.1.rRNAcut.names.txt"),header=F,stringsAsFactors=F) 
